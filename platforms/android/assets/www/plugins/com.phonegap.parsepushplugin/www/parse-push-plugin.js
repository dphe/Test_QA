cordova.define("com.phonegap.parsepushplugin.ParsePushPlugin", function(require, exports, module) { var serviceName = 'ParsePushPlugin';
...
var ParsePushPlugin = {
    ...
    saveInstallation: function(successCb, errorCb){
    	cordova.exec(successCb,errorCb,serviceName,'saveInstallation',[]);
    }
};
