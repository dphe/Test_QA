...
public class ParsePushPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("saveInstallation")) {
            this.saveInstallation(callbackContext);
            return true;
        }
        return false;
    }
    ...
    private void saveInstallation(final CallbackContext callbackContext){
        cordova.getThreatPool().execute(new Runnable(){
            public void run(){
                ParseInstallation.getCurrentInstallation().saveInBackground();
                callbackContext.success();
            }
